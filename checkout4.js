...
var emailAddress = 'wishcolor0@gmail.com';
// Fetches a payment intent and captures the client secret
async function initialize() {

    const response = await fetch('./pay3.php');
...
async function handleSubmit(e) {
    ...
    const { error } = await stripe.confirmPayment({
        ...
        confirmParams: {
            //完成付款(or失敗要跳轉的頁面)
            return_url: "http://localhost/phpuse/stripe/success.html",
